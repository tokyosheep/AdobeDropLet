...
;// CONCATENATED MODULE: ./redux/actions/AIActions.ts
var actionsAI_set = function actionsAI_set(actions) {
  return {
    type: "actionsAI_set",
    actions: actions
  };
};
var actionsAI_remove = function actionsAI_remove() {
  return {
    type: "actionsAI_remove"
  };
};
var selectedAI_set = function selectedAI_set(set, action) {
  return {
    type: "selectedAI_set",
    set: set,
    action: action
...
var selectedAI_setAction = function selectedAI_setAction(action) {
  return {
    type: "selectedAI_setAction",
    action: action
  };
};
...
var ElectronURL = 2000;



var connectServer = function connectServer(receiveDropped) {
...
var sendAIFile = /*#__PURE__*/function () {
  var _ref = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee(data, url) {
    var ext, res;
    return regenerator_default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            console.log(data);
            ext = external_path_namespaceObject.extname(data.file).toLowerCase();
  ...
  return function sendAIFile(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
;// CONCATENATED MODULE: ./style/containers.ts

var AIContainers = {
  Container: styled_components_browser_esm.div.withConfig({
    displayName: "containers__Container",
    componentId: "sc-1lgn91q-0"
  })(["display:grid;background:rgb(200,150,150);grid-template-columns:100%;grid-template-rows:50px minmax(300px,1fr) 50px;grid-template-areas:\"headerAI\" \"mainAI\" \"footerAI\";"]),
  HeaderAi: styled_components_browser_esm.header.withConfig({
    displayName: "containers__HeaderAi",
    componentId: "sc-1lgn91q-1"
  })(["grid-area:headerAI;"]),
  MainAICompo: styled_components_browser_esm.main.withConfig({
    displayName: "containers__MainAICompo",
    componentId: "sc-1lgn91q-2"
  })(["grid-area:mainAI;padding:5px;box-sizing:border-box;"]),
  FooterAI: styled_components_browser_esm.footer.withConfig({
    displayName: "containers__FooterAI",
    componentId: "sc-1lgn91q-3"
  })(["grid-area:footerAI;"])
};
;// CONCATENATED MODULE: ./components/AI/footer/footerAI.tsx


var FooterAI = AIContainers.FooterAI;

var Footer = function Footer() {
  return /*#__PURE__*/react.createElement(FooterAI, null);
};

/* harmony default export */ const footerAI = (Footer);
;// CONCATENATED MODULE: ./style/mixin.ts

var StdTitle = styled_components_browser_esm.h3.withConfig({
  displayName: "mixin__StdTitle",
  componentId: "yk5wv5-0"
})(["color:#fff;font-size:13px;font-weight:300;"]);
;// CONCATENATED MODULE: ./parts/selector.tsx



var ActionBoxWrapper = styled_components_browser_esm.div.withConfig({
  displayName: "selector__ActionBoxWrapper",
  componentId: "gqxb7c-0"
})(["padding:5px;width:100%;box-sizing:border-box;border:1px solid #666;border-radius:5px;background:rgba(250,150,100,0.2);"]);
var ActionSelectorWrapper = styled_components_browser_esm.ul.withConfig({
  displayName: "selector__ActionSelectorWrapper",
  componentId: "gqxb7c-1"
})(["height:60px;width:100%;overflow:scroll;background:rgba(0,0,0,0.2);list-style:none;padding:0;cursor:pointer;"]);
var ActionRadioLabel = styled_components_browser_esm.label.withConfig({
  displayName: "selector__ActionRadioLabel",
  componentId: "gqxb7c-2"
})(["width:100%;height:20px;text-align:center;border-bottom:1px solid #000;display:block;background:", ";"], function (props) {
  return props.checked ? "rgba(200,200,200,0.2)" : "rgba(0,0,0,0)";
});
var RadioInput = styled_components_browser_esm.input.withConfig({
  displayName: "selector__RadioInput",
  componentId: "gqxb7c-3"
})(["display:none;"]);
var RadioTitle = styled_components_browser_esm.p.withConfig({
  displayName: "selector__RadioTitle",
  componentId: "gqxb7c-4"
})(["margin:0;color:#fff;font-size:12px;font-weight:200;"]);
var ActionSelector = function ActionSelector(_ref) {
  var actions = _ref.actions,
      name = _ref.name,
      index = _ref.index,
      func = _ref.func;
  var aciontBoxes = actions.map(function (ac, i) {
    return /*#__PURE__*/react.createElement("li", {
      key: i
    }, /*#__PURE__*/react.createElement(ActionRadioLabel, {
      checked: index === i
    ...
    }), /*#__PURE__*/react.createElement(RadioTitle, null, ac)));
  });
  return /*#__PURE__*/react.createElement(ActionBoxWrapper, null, /*#__PURE__*/react.createElement(StdTitle, null, name), /*#__PURE__*/react.createElement(ActionSelectorWrapper, null, aciontBoxes));
};
;// CONCATENATED MODULE: ./components/AI/main/mainAi.tsx
...
var MainAICompo = AIContainers.MainAICompo;

var MainAI = function MainAI() {
  var dispatch = useDispatch();
  var actions = useSelector(function (state) {
    return state.AIActions;
  });
  var selectedAc = useSelector(function (state) {
    return state.selectedAiAction;
  });
  var handleSet = (0,react.useCallback)(function (index, name) {
    dispatch(selectedAI_set({
      name: name,
      index: index
    }, {
      name: actions[index].actions[0],
      index: 0
    }));
  }, [selectedAc]);
  var handleAction = (0,react.useCallback)(function (index, name) {
    dispatch(selectedAI_setAction({
      name: name,
      index: index
    }));
  }, [selectedAc]);
  return /*#__PURE__*/react.createElement(MainAICompo, null, /*#__PURE__*/react.createElement(ActionSelector, {
    actions: actions.map(function (ac) {
      return ac.setName;
    }),
    name: "action sets",
    index: selectedAc.set.index,
    func: handleSet
  }), /*#__PURE__*/react.createElement(ActionSelector, {
    actions: actions[selectedAc.set.index].actions,
    name: "actions",
    index: selectedAc.action.index,
    func: handleAction
  }));
};

/* harmony default export */ const mainAi = (MainAI);
;// CONCATENATED MODULE: ./components/AI/header/headerAI.tsx



var HeaderAi = AIContainers.HeaderAi;
var Title = styled_components_browser_esm.h1.withConfig({
  displayName: "headerAI__Title",
  componentId: "sc-1c303bk-0"
})(["font-size:16px;color:#fff;font-weight:3000;"]);

var Header = function Header() {
  return /*#__PURE__*/react.createElement(HeaderAi, null, /*#__PURE__*/react.createElement(Title, null, "AI droplet"));
};

/* harmony default export */ const headerAI = (Header);
;// CONCATENATED MODULE: ./pages/AIPage.tsx





var Container = AIContainers.Container;

var AiPage = function AiPage() {
  return /*#__PURE__*/react.createElement(Container, null, /*#__PURE__*/react.createElement(headerAI, null), /*#__PURE__*/react.createElement(mainAi, null), /*#__PURE__*/react.createElement(footerAI, null));
};

/* harmony default export */ const AIPage = (AiPage);
...
var GlobalStyle = $e(_templateObject || (_templateObject = taggedTemplateLiteral_default()(["\n    body{\n        margin: 0;\n        font-family: \"Helvetica Neue\" , Helvetica , Arial , Verdana , Roboto , \"\u6E38\u30B4\u30B7\u30C3\u30AF\" , \"Yu Gothic\" , \"\u6E38\u30B4\u30B7\u30C3\u30AF\u4F53\" , \"YuGothic\" , \"\u30D2\u30E9\u30AE\u30CE\u89D2\u30B4 Pro W3\" , \"Hiragino Kaku Gothic Pro\" , \"Meiryo UI\" , \"\u30E1\u30A4\u30EA\u30AA\" , Meiryo , \"\uFF2D\uFF33 \uFF30\u30B4\u30B7\u30C3\u30AF\" , \"MS PGothic\" , sans-serif;\n        background: #e2914e;\n    }\n"])));
...
var Layout = function Layout() {
  ...
  (0,react.useMemo)(function () {
      ...
      return regenerator_default().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return external_electron_namespaceObject.ipcRenderer.invoke("sendData", "");
    ...
    server( /*#__PURE__*/function () {
      var _ref2 = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee2(r) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 5;
                return external_electron_namespaceObject.ipcRenderer.invoke("saveData", r);
  ...
  var received = /*#__PURE__*/function () {
    var _ref3 = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee3(event, message) {
    ...
    return function received(_x2, _x3) {
      return _ref3.apply(this, arguments);
    };
  }();

  (0,react.useEffect)(function () {
    external_electron_default().ipcRenderer.removeAllListeners("dropFile"); //selectedが更新されるたびにipcRenderderも更新

    external_electron_default().ipcRenderer.on("dropFile", received);

    asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee4() {
      return regenerator_default().wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return external_electron_namespaceObject.ipcRenderer.invoke("saveSelected", selected);
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(GlobalStyle, null), /*#__PURE__*/react.createElement(AIPage, null));
};

/* harmony default export */ const layout = (Layout);
;// CONCATENATED MODULE: ./redux/redux/AIactions.ts
var initActions = [{
  setName: "",
  actions: [""]
}];
var AIActions = function AIActions() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initActions;
...
var selectedAiAction = function selectedAiAction() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initSelectedAI;
  var action = arguments.length > 1 ? arguments[1] : undefined;
